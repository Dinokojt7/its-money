...
class ResultsPage extends StatelessWidget {
  ...
  const ResultsPage({Key? key, required this.package, required this.feedback})
      : super(key: key);
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
              ...
              childCard: Column(
                ...
                children: [
                  ...
                  BorderedText(
                    ...
                    child: Text(
                      feedback,
                      style: resultBodyTextStyle.copyWith(
          ...
          Padding(
            padding:
                EdgeInsets.symmetric(horizontal: Dimensions.screenWidth / 5.5),
            child: BottomButton(
              title: 'RE-CALCULATE',
              onTap: () {
